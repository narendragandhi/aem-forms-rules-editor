 ...
 */
package com.adobe.aem.forms.rules.core.models;
...
import com.adobe.aem.forms.rules.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "aem-forms-rules-editor/components/helloworld");
